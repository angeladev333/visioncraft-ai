...
test_list2 = ['https://oaidalleapiprodscus.blob.core.windows.net/private/org-YZvXU50h6T98gbbQPiQR535H/user-gGyy3JIbTte24mXa2939d2g8/img-T43ofCSuksNWAsW71g6IZ2iw.png?st=2023-08-20T01%3A56%3A05Z&se=2023-08-20T03%3A56%3A05Z&sp=r&sv=2021-08-06&sr=b&rscd=inline&rsct=image/png&skoid=6aaadede-4fb3-4698-a8f6-684d7786b067&sktid=a48cca56-e6da-484e-a814-9c849652bcb3&skt=2023-08-19T17%3A48%3A24Z&ske=2023-08-20T17%3A48%3A24Z&sks=b&skv=2021-08-06&sig=vXbjkoyFGjHCO/RATKAwcp1dN/lVM%2BD2n/t4WJdqn9c%3D']
...
def create_pdf(idea, budget, materials):
    class PDF(FPDF):
        ...
        def body_page(self, title, output, image):
            ...
            self.image(image, x = None, y = None, w = 0, h = 0, type = 'PNG', link=image)
    ...
    for index in range(len(ai_images)):
        pdf.body_page(topics[index], ai_images[index], ai_images[index])
    """
    # Calls the function
