  ...
  return (
    <div className="flex items-center justify-center h-screen bg-center bg-cover bg-[url('/gradients1.png')]">
      <div className="text-center z-10">
        <h2 className="text-2xl font-bold p-6 bg-clip-text text-transparent bg-gradient-to-t from-[#9971fe] to-blue-400">
        ...
        <h1 className="text-8xl font-extrabold p-6 text-violet-600">
          <span className="text-[#d6ebff]-450  bg-[#9971fe] bg-opacity-30 p-2 inline-block">
            Our{" "}
            <Typewriter
        ...
        <p className="text-2xl w-2/3 break-normal mx-auto p-6">
          VisionCraft.ai is a new way to capture and analyze your hardware setup,
