    ...
    <>
      <div className="bg-slate-100 pt-36 pb-16">
        <div className="mt-8 bg-slate-100 p-4 rounded-3xl pb-40">
          <h2
            data-aos="fade-up"
            className="text-8xl font-bold pr-40 px-40 bg-clip-text text-transparent bg-gradient-to-t from-violet-500 to-blue-400 text-center "
          >
        ...
        <div className="flex flex-col items-center justify-center min-h-screen bg-fixed bg-center bg-cover custom-img">
          <div className="text-center z-10" id="features">
            <div
              className="bg-white p-4 rounded shadow-md rounded-3xl pb-20"
              data-aos="fade-right"
            >
            ...
            <div
              className="mt-8 bg-white p-4 rounded shadow-md rounded-3xl pb-20"
              data-aos="fade-left"
            >
              <h2 className="text-4xl font-bold p-6 text-violet-500">
                TRANSFORM
              </h2>
              ...
              <div className="px-2 max-w-4xl mx-auto sm:flex h-96">
                ...
                <div className="flex w-full sm:w-1/2 items-center justify-center">
                  <p className="px-2 sm:px-12 text-3xl text-gray-900">
                    ...
                    personalized creations with step-by-step guidance
                  </p>
                </div>
              </div>
            </div>
